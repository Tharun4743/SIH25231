...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public DatabaseInitializer(SettingRepository settingRepository, AuditLogService auditLogService, SettingService settingService) {
    ...
    public void run(String... args) {
        ...
        if (settingRepository.count() == 0) {
            ...
            defaults.put("auto_start_ollama", "true");
        ...
        // Synchronize Electron config file
        settingService.writeElectronConfig();
