...
public class ImageService {
    ...
    public void indexImage(MultipartFile image) throws IOException {
        ...
        try {
            ...
            if (exitCode == 0) {
                ...
                log.info("[AURA] CLIP embedding generated for: {}", filename);
            }
        } catch (Exception e) {
            log.info("[AURA] CLIP sidecar unavailable, switching to nomic-embed-text for: {}", filename);
        }
        ...
        if (embedding == null) {
            ...
            log.info("[AURA] nomic-embed-text embedding generated for image: {}", filename);
        }
        ...
        log.info("[AURA] Image indexed in visual collection: {}", filename);
    }
    ...
    public List<Map<String, Object>> searchImages(String query) {
        ...
        try {
            ...
            log.info("[AURA] CLIP text encode unavailable, using nomic-embed-text for query: {}", query);
        }
